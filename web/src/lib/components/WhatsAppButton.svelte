<script lang="ts">
	...
	const href = $derived(`https://wa.me/${PHONE}?text=${encodeURIComponent(t('ui.whatsappMsg'))}`);
</script>
...
<a
	...
	class="wa-fab fixed right-5 bottom-5 z-50 grid h-14 w-14 place-items-center rounded-full text-white shadow-lift transition-transform hover:-translate-y-0.5"
